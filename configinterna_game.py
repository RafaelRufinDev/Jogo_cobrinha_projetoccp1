...
class Window:
    ...
    def home_screen(self, button_list, button_layout=(1, 1)):
        # button_list   = list(tuple(name, color))(lista que contem tuplas, sendo o nome e a cor )
        # button_layout = tuple(row, column)( botão que define variáveis de linhas e colunas) 
